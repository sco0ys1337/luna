...
local library = {
    ...
    images = {
        ['gradientp90'] = 'https://www.octohook.xyz/assets/ay2rnhSSVKCQtUKYYdPPH5pH37XZHHNwpvNrva9c1jsVqmOVfO.png';
        ['gradientp45'] = 'https://octohook.xyz/assets/p0JnYfBJi5NWh0dH8O8Cozx0eNRP5Y2HXyTd4TYKuQcWto2RSG.png';
        ['colorhue'] = 'https://www.octohook.xyz/assets/0RPDNQ1FfZWtmHvX9glFYW85MCUB8SYaDOyibFWE4eVs6TE6vt.png';
        ['colortrans'] = 'https://octohook.xyz/assets/I05svPLPJk73c1oLlcXAPd907vcRrUnmTjTzK1zaXjYnFGYSoK.png';
    ...
    opening = false;
    hasInit = false;
    cheatname = startupArgs.cheatname or 'luna v2';
...
function library:Unload()
    ...
    for _,obj in next, self.instances do
        obj:Destroy()
    end
...
function library:CreateSettingsTab(menu)
    ...
    mainSection:AddBind({text = 'open / close', flag = 'togglebind', nomouse = true, noindicator = true, default = Enum.KeyCode.End, bind = Enum.KeyCode.End, callback = function()
    ...
    mainSection:AddButton({text = 'copy discord', flag = 'copydiscord', callback = function()
        setclipboard('discord.gg/bD6rc7Hefh')
    end})
